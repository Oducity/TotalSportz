(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(){let e=`Last Updated: ${new Date().toLocaleDateString(`en-US`)}`;document.querySelector(`#latestModified`).textContent=e}function t(e){let t=new Date().getFullYear();document.querySelector(`#yearcopyright`).textContent=t.toString()}var n=`/assets/hero1-Bv1OS4UL.webp`;function r(){document.querySelector(`title`).textContent=`TotalSportz || Home - page`;let e=document.querySelector(`#main`);e.innerHTML=`
  ...
  `}async function i(e,t,n,r){let i=`https://${e}${t}`,a={method:`GET`,headers:{"x-rapidapi-key":n,"x-rapidapi-host":e,"Content-Type":r}};try{let e=await fetch(i,a);if(e.ok)return await e.json();{let t=await e.text();console.log(t)}}catch(e){console.error(e)}}async function a(){let e=await i(`therundown-therundown-v1.p.rapidapi.com`,`/events/5527455bb80a5e9884153786aeb5f2b2?include=scores`,`d5e371912emshe979d50bdbd81f0p15c7c5jsn0e0e5bdbf686`,`application/json`),t=``,n=``;e.teams.forEach(e=>{e.is_home?t=e.name:n=e.name});let r=document.querySelector(`#fixtures`);r.innerHTML=``;let a=document.createElement(`h2`);a.innerHTML=`
    ...
    `}async function f(){let e=await i(`free-api-live-football-data.p.rapidapi.com`,`/football-get-all-leagues`,`d5e371912emshe979d50bdbd81f0p15c7c5jsn0e0e5bdbf686`,`application/json`),t=document.getElementById(`preferred-team`);e.response.leagues.forEach(e=>{let n=document.createElement(`option`);n.value=`${e.id} : ${e.name}`,n.innerText=e.name,t.appendChild(n)})}async function p(e){document.getElementById(`reg-form`).addEventListener(`submit`,e=>{e.preventDefault();let t={firstName:document.getElementById(`firstname`).value,lastName:document.getElementById(`lastname`).value,email:document.getElementById(`email`).value,team:document.getElementById(`preferred-team`).value};localStorage.setItem(`userData`,JSON.stringify(t))})}async function m(){let e=localStorage.getItem(`userData`),t=document.getElementById(`main`);t.innerHTML=``;let n=document.createElement(`h1`);n.textContent=`Registration Completed`;let r=document.createElement(`p`);if(r.innerText=`The following are information you provided during your registration.`,t.appendChild(n),t.appendChild(r),e){let n=JSON.parse(e);console.log(n);let r=document.createElement(`p`);r.setAttribute(`class`,`first-name`),r.innerHTML=`<span>First Name</span>: <span>${n.firstName}`;let i=document.createElement(`p`);i.setAttribute(`class`,`last-name`),i.innerHTML=`<span>Last Name</span>: </span>${n.lastName}</span>`;let a=document.createElement(`P`);a.setAttribute(`class`,`email`),a.innerHTML=`<span>Email</span>: <span>${n.email}</span>`;let o=document.createElement(`P`);o.setAttribute(`class`,`team`),o.innerHTML=`<span>Preferred Team</span>: <span>${n.team}`,t.appendChild(r),t.appendChild(i),t.appendChild(a),t.appendChild(o),t.classList.add(`formdata`)}else t.innerHTML=`<p><strong> No data recieved! </strong> </P`}document.getElementById(`search-btn`),document.getElementById(`mymodal`),document.getElementById(`close-dialog`);var h=document.querySelectorAll(`a`);h.forEach(e=>{e.addEventListener(`click`,()=>{e.classList.contains(`sports`)?(h.forEach(e=>e.classList.remove(`pathfinder`)),e.classList.add(`pathfinder`),o(),s(),c(),l(),u()):e.classList.contains(`home`)?(h.forEach(e=>e.classList.remove(`pathfinder`)),e.classList.add(`pathfinder`),r(),a()):e.classList.contains(`contact-Us`)&&(h.forEach(e=>e.classList.remove(`pathfinder`)),e.classList.add(`pathfinder`),d(),f(),p(),document.getElementById(`form-submit`).addEventListener(`click`,()=>{m()}))})}),document.getElementById(`home`)&&(document.getElementById(`home`).classList.add(`pathfinder`),r(),a()),e(),t();