...
export default function displayHeroPhotos() {
  ...
  main.innerHTML = `
  <div class="hero-container"><img src="https://github.com/Oducity/TotalSportz/src/images/hero1.webp" laoding="lazy" width="320" alt="Hero image of a player happily raising a throphy."></div>
